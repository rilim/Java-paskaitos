...
public class AutomobilisImpl extends TransportasImpl implements Automobilis {
    ...
    public AutomobilisImpl(String transportoTipas, boolean arYraVariklis, int pagaminimoMetai, int rida, String automobilioMarke,
                           int duruSkaicius, boolean arVaromasElektra){
        super(transportoTipas, arYraVariklis, pagaminimoMetai, rida);
