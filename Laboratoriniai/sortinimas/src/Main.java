...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //išrenkami objektai, kurių rida daugiau kip 500tūkst. ir tuomet rida pakeičiama į 300
        for (Automobilis auto : automobiliai) {
            if(auto.getRida()>500000){
                auto.setRida(300);
            }
        }

        //ištrinami objektai, kurių rida daugiau kaip 500tūkst.
